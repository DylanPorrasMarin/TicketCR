...
$('#nacimiento').daterangepicker({
    locale: {
        format: "YYYY-MM-DD", // formato de la fecha sin las horas aqui depende de el que tengan.
         applyLabel: "Aplicar",
            ...
            if (!validarCorreo(correo)) {
                ...
                if (password1 !== password2) {
                    ...
                    if (!validarTelefono(telefono)) {
                        ...
                        mensajeConfirmacionAnimado('¡Modificación exitosa!', 'Su solicitud ha sido enviada.');
